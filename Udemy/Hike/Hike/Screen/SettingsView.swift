    ...
    var body: some View {
        List {
            ...
            Section{
                ...
                VStack(spacing: 8) {
                    Text("Where can you find \nperfect tracks?")
                        .font(.title2)
                        .fontWeight(.heavy)
                    Text("The hike which looks gorgeous in photos but is even better once you ar actually there. The hike that you hope to do again someday. \nFind the best day hikes in the app")
                        .font(.footnote)
                        .italic()
            ...
            Section(header: Text("ABOUT THE APP"), footer: HStack {
                ...
                // LabeledContent 와 Label 차이점???
                // LabeledContent("Application", value: "Hike")
                
                // 2. Advaned Labeld Content
